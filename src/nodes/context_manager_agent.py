...
from ..interfaces.core.context import ContextProvider, ContextEntry
...
class ContextManagerAgentNode:
    ...
    def _get_case_resolution_info(self, entry_id: str) -> Optional[Dict[str, Any]]:
